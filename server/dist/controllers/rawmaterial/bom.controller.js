...
class BOMController {
    ...
    static async createBOM(req, res) {
        try {
            const { bomCode, productName, productCode, unitOfMeasurement, outputQuantity, description, status, items, // Array of { rawMaterialId, quantity, unitOfMeasurement, notes }
             } = req.body;
    ...
    static async getBOMBySFG(req, res) {
        try {
    ...
    static async updateBOM(req, res) {
        try {
            const { id } = req.params;
            const { bomCode, productName, productCode, unitOfMeasurement, outputQuantity, description, status, items, } = req.body;
