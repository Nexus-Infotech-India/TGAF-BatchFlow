...
exports.GrindingDispatchController = void 0;
...
class GrindingDispatchController {
    /**
     ...
     */
    static async acceptDispatch(req, res) {
        try {
            const { id } = req.params;
            const dispatch = await prisma.grindingDispatch.findUnique({
                where: { id },
     ...
     */
    static async rejectDispatch(req, res) {
        try {
            const { id } = req.params;
...
exports.GrindingDispatchController = GrindingDispatchController;
