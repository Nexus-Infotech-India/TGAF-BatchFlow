...
class GRNController {
    ...
    static async createGRN(req, res) {
        try {
            const { purchaseOrderId, purchaseOrderItemId, rawMaterialName, variety, supplier, parameters, } = req.body;
    ...
    static async getReceivedPOs(req, res) {
        try {
    ...
    static async generateGRNForReport(req, res) {
        try {
