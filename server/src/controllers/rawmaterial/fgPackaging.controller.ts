...
export class FGPackagingController {
  // Get all FG Packaging settings, with product relation
  static async getFGPackagingSettings(req: Request, res: Response): Promise<void> {
    try {
  ...
  static async getFGPackagingByProductId(req: Request, res: Response): Promise<void> {
    try {
  ...
  static async upsertFGPackagingSetting(req: Request, res: Response): Promise<void> {
    try {
  ...
  static async deleteFGPackagingSetting(req: Request, res: Response): Promise<void> {
    try {
      const { id } = req.params;
