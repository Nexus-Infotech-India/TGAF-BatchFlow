...
const AddStandardParameter: React.FC<AddStandardParameterProps> = ({
  onSuccess,
  onCancel,
}) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await api.post(API_ROUTES.STANDARD.CREATE_STANDARD_PARAMETER, payload, {
        headers: {
          Authorization: `Bearer ${authToken}`,
        },
      });
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full border border-[var(--border)] rounded-lg pl-10 pr-4 py-2.5 focus:ring-2 focus:ring-[var(--primary)] focus:border-[var(--primary)] outline-none transition-all duration-200 bg-[var(--background)] text-[var(--foreground)]"
            ...
            <div>
              ...
              {isLoadingCategories ? (
                <div className="flex items-center space-x-2 text-sm text-[var(--muted-foreground)] py-2">
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full appearance-none border border-[var(--border)] rounded-lg pl-4 pr-10 py-2.5 focus:ring-2 focus:ring-[var(--primary)] focus:border-[var(--primary)] outline-none transition-all duration-200 bg-[var(--background)] text-[var(--foreground)]"
                    required
                  >
          ...
          <div>
            ...
            <div className="relative">
              ...
              <textarea
                ...
                className="w-full border border-[var(--border)] rounded-lg pl-10 pr-4 py-2.5 focus:ring-2 focus:ring-[var(--primary)] focus:border-[var(--primary)] outline-none transition-all duration-200 min-h-[100px] bg-[var(--background)] text-[var(--foreground)]"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <select
                ...
                className="w-full appearance-none border border-[var(--border)] rounded-lg pl-10 pr-10 py-2.5 focus:ring-2 focus:ring-[var(--primary)] focus:border-[var(--primary)] outline-none transition-all duration-200 bg-[var(--background)] text-[var(--foreground)]"
                required
              >
          ...
          <div className="border-t border-[var(--border)] pt-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                <BarChart className="h-5 w-5 text-[var(--primary)]" />
            ...
            {showStandardValue && (
              <motion.div
                className="space-y-5 bg-[var(--primary)]/10 p-4 rounded-lg border border-[var(--primary)]/20 mt-2"
                initial={{ opacity: 0, height: 0 }}
                animate={{ opacity: 1, height: 'auto' }}
                transition={{ duration: 0.3 }}
              >
                <p className="text-sm text-[var(--primary)]">
                  Define the expected value for this parameter according to
                  quality standards.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1.5 text-xs text-[var(--muted-foreground)]">
                      The expected value or range (e.g., "10", "5.5-7.8", "≤
                      2.0")
                    </p>
                  </div>
          ...
          <div className="flex justify-end gap-3 pt-2">
            <motion.button
              type="button"
              onClick={onCancel}
              className="px-5 py-2.5 border border-[var(--border)] text-[var(--primary)] rounded-lg hover:bg-[var(--primary)]/10 transition-colors flex items-center gap-2 shadow-sm"
