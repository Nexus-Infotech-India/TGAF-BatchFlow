...
const SIDEBAR_SECTIONS: SidebarSection[] = [
  ...
  },
  {
    ...
    description: 'Dispatch to grinding, SFG processing, SFG leftouts, Outbound to SFG WH, Stock Verification, Loose Stock',
    permissionKeys: [
      'send_cleaned_to_grinding',
      'manage_processing_list',
      'view_sfg_production_leftouts',
      'dispatch_to_sfg',
  ...
  },
  {
    ...
    description: 'Material transfer, receive, FG production, FG leftouts, outbound, FG verification',
    permissionKeys: [
      'manage_pkg_material_transfer',
      'manage_pkg_receive_materials',
      'manage_fg_production',
      'view_fg_production_leftouts',
...
const PERMISSION_LABELS: Record<string, string> = {
  ...
  view_sfg_production_leftouts: 'SFG Production Leftouts',
  ...
  manage_loose_stock: 'Loose Stock',
  ...
  view_fg_production_leftouts: 'FG Production Leftouts',
