...
export const API_ROUTES = {
  ...
  RAW: {
    ...
    GET_REBAG_HISTORY: `${BASE_URL}/raw/transfers/loose-stock/rebag-history`,
    ...
    SUBMIT_FG_QUALITY_CHECK: (id: string) => `${BASE_URL}/raw/fg-batch/production-entries/${id}/quality`,
